...
import static it.sms1920.spqs.ufit.model.firebase.database.User.JPG;
import static it.sms1920.spqs.ufit.model.firebase.database.User.NAME_FIELD;
import static it.sms1920.spqs.ufit.model.firebase.database.User.PATH_STORAGE_PIC;
...
public class ChangeProfileInfoPresenter implements ChangeProfileInfoContract.Presenter {
    private ChangeProfileInfoContract.View view;

    private DatabaseReference database;
    private FirebaseUser firebaseUser;
    private StorageReference mStorageRef = FirebaseStorage.getInstance().getReference();

    public ChangeProfileInfoPresenter(ChangeProfileInfoContract.View view) {
